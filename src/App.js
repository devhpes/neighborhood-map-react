...
handlingSearchQuery = (query) => {
  ...
  render() {
    return (
      ...
      <h2>Food Places</h2>
      <div id="search">
      <input type="text" placeholder="Search.." className="insideSearch" aria-labelledby="filter" value={this.state.query} onChange={(e) => {this.handlingSearchQuery(e.target.value)}}></input>
      </div>
      </div>
